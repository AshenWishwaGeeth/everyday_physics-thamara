...
const Dashboard: React.FC = () => {
  ...
  const handleYearClick = (yearNumber: string) => {
    // Navigate to StudentList page for the selected year
    navigate(`/student-list/${yearNumber}`);
  };
            ...
            {years.map((y) => (
              <Card
                ...
                sx={{
                  width: 350,
                  borderRadius: 5,
                  border: y.highlight ? "3px solid #1e88e5" : "3px solid transparent",
                ...
                onClick={() => handleYearClick(y.number)} // <-- Click handler
              >
